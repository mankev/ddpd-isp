...
namespace Drupal\gcext\Plugin\Condition;
...
class NodeHasTerm extends ConditionPluginBase implements ContainerFactoryPluginInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $selected = isset($values[$form_key]['gcext_node_has_term']['vocabulary']) ? $values[$form_key]['gcext_node_has_term']['vocabulary'] : NULL;
...
*/
  ...
  public function listTermsCallback(array $form, FormStateInterface $form_state) {
    ...
    $selected = $values[$form_key]['gcext_node_has_term']['vocabulary'];
    //$form['conditions']['gcext_node_has_term']['terms']['#options'] = $this->getTerms($selected); 
    $language = \Drupal::languageManager()->getCurrentLanguage()->getId();
    $element = $form[$form_key]['gcext_node_has_term']['terms'];
    $element['#vocabulary'] = $selected;
    $form[$form_key]['gcext_node_has_term']['terms']['#options'] = self::getOptionsTree($element, $language); 

    return $form[$form_key]['gcext_node_has_term']['terms'];
  }
